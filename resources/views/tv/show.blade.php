...
{{-- Movie Info --}}
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
            <img src="{{$tvshow['poster_path']}}" alt="poster" class=" w-64 md:80 hover:opacity-75 transition ease-in-out duration-150">

            </div>
            <div class="md:ml-24">
                <h3 class="text-3xl font-semibold"> {{ $tvshow['name'] }} </h3>
                            ...
                            <div class="bg-gray-900 rounded">
                                ...
                                <div class="modal-body px-8 py-8">
                                    {{-- <div class="responsive-container overflow-hidden relative" style="padding-top:56.25%;">
                                        <iframe src="https://youtube/watch?v={{$tvshow['videos']['results']['0']['key']}}" width="560" height="335" class="responsive-iframe absolute top-0 left-0 w-full h-full" style="border:0;" allow="autoplay; encrypted-media" allowfullscreen frameborder="0"></iframe>
                                    </div> --}}
